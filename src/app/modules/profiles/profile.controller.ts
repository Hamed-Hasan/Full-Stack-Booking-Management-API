...
const getProfiles = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: 'Profiles fetched successfully.', data: result });
});

const getProfile = catchAsync(async (req: Request, res: Response) => {
  const result = await ProfileService.getProfile(req.params.userId);
  sendResponse(res, { statusCode: 200, success: true, message: 'Profile fetched successfully.', data: result });
});

const updateProfile = catchAsync(async (req: Request, res: Response) => {
  const result = await ProfileService.updateProfile(req.params.userId, req.body);
...
const deleteProfile = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: 'Profile deleted successfully.', data: result });
});
