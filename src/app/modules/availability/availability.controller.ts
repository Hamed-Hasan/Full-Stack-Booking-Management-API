...
const createAvailability = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 201, success: true, message: 'Availability created successfully.', data: availability });
});
...
const getAvailability = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: 'Availability fetched successfully.', data: availability });
});

const updateAvailability = catchAsync(async (req: Request, res: Response) => {
  const availability = await AvailabilityService.updateAvailability(req.params.id, req.body);
  sendResponse(res, { statusCode: 200, success: true, message: 'Availability updated successfully.', data: availability });
});
...
const deleteAvailability = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: 'Availability deleted successfully.' });
});
...
const listAvailabilities = catchAsync(async (req: Request, res: Response) => {
  ...
  sendResponse(res, { statusCode: 200, success: true, message: 'Availabilities listed successfully.', data: availabilities });
});
